            ...
            <div class="columns">
                <div class="column">
                        ...
                        <div class="columns is-vcentered">
                            ...
                            <div class="column">
                                <div class="field is-grouped is-pulled-right">
                                    ...
                                    <div class="control">
                                        <a href="{{route('responsables.pdf')}}" class="button is-dark" target="_blank">Imprimir PDF</a>
                                    </div>
                                    <div class="control">
                                        @verbatim
                    ...
                    <transition name="fade">
                        <div v-show="responsables.length <= 0 && !busqueda && !cargando.lista" class="notification is-info has-text-centered">
                    ...
                    <transition name="fade">
                        <div v-show="responsables.length <= 0 && busqueda && !cargando.lista" class="notification is-warning has-text-centered">
                        ...
                        <table v-show="responsables.length > 0 && !cargando.lista" class="table is-bordered is-striped is-hoverable is-fullwidth">
                            ...
                            <tbody>
                                ...
                                <tr v-for="responsable in responsables">
                                    <td>
                                        <button @click="invertirEstado(responsable)" class="button" :class="{'is-info': responsable.marcado}">
                                            <span class="icon is-small">
                                                <i class="fa fa-check"></i>
                                            </span>
                                        </button>
                                    ...
                                    <td>
                                        <button @click="eliminar(responsable)" class="button is-danger" :class="{'is-loading': responsable.eliminando}">
                                            <span class="icon is-small">
